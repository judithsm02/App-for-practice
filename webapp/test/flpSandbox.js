		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Judith Practice",
									"targetURL": "#practiceapppracticej-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"practiceapppracticej-display": {
								"semanticObject": "practiceapppracticej",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=practiceapp.practicej",
									"url": sap.ui.require.toUrl("practiceapp/practicej")
								}
							}
						}
					}
